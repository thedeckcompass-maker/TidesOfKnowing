...
| Complete creator journey | In progress | The creator-pathway form opens after the successful sandbox payment. Submit onboarding, exercise manuscript/version history, programme, journal, production and current exports, and check access from an unrelated account. |
