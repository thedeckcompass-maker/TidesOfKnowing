...
| Complete creator journey | Onboarding and project creation reached; content journey pending | The owner submitted onboarding and created a staging test project with the commercial/crowdfunded pathway, planned deck size 78 and Kickstarter purpose. The browser reached `/studio/projects/2b55720e-1bfa-4cab-bf66-9bbe6c8f4d43/?created=1`. Verify the project page renders, then exercise family and card creation, manuscript/version history, programme, journal, production and current exports, and check access from an unrelated account. A planned deck size of 78 does not itself create 78 cards. |
