---
type: field-note
fieldNoteSlug: how-i-use-the-four-knights-in-tarot
title: "How I Use the Four Knights in Tarot When the Work Needs to Move"
description: "A personal Field Note on using the four Knights in tarot as focused working energies for motivation, direction, and intuitive decision-making when a project needs movement."
date: 2026-05-22
...
ogTitle: "How I Use the Four Knights in Tarot for Focus, Work, and Direction | Field Notes | Tides of Knowing"
ogDescription: "A personal Field Note on using the four Knights as focused working energies when a project needs movement, direction, or clearer intuitive posture."
shortAnswer: "I use the four Knights in tarot as focused working energies when a project needs movement. Pages help me notice what is emerging; Knights help me proceed. By drawing one Knight from the four, I can clarify whether the work needs practical steadiness, emotional attunement, intellectual clarity, or creative ignition."
---

## Preview

This Field Note explores how I use the four Knights in tarot as focused working energies when a project needs movement. It is for readers, writers, solo practitioners, and intuitive workers who want a practical way to clarify whether their work needs steadiness, emotional attunement, intellectual clarity, or creative momentum.
...
<figure style="clear: both; margin: 2rem auto; max-width: 26rem; text-align: center;">
  <div style="display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 0.65rem;">
    <img src="/images/tarot/rws/knight-of-pentacles.jpg" alt="Rider-Waite-Smith Knight of Pentacles" width="120" height="209" loading="lazy" decoding="async" style="display: block; width: 100%; height: auto; object-fit: contain; border: 1px solid color-mix(in srgb, var(--tok-gold) 30%, transparent); border-radius: 2px;" />
    <img src="/images/tarot/rws/knight-of-cups.jpg" alt="Rider-Waite-Smith Knight of Cups" width="120" height="209" loading="lazy" decoding="async" style="display: block; width: 100%; height: auto; object-fit: contain; border: 1px solid color-mix(in srgb, var(--tok-gold) 30%, transparent); border-radius: 2px;" />
    <img src="/images/tarot/rws/knight-of-swords.jpg" alt="Rider-Waite-Smith Knight of Swords" width="120" height="209" loading="lazy" decoding="async" style="display: block; width: 100%; height: auto; object-fit: contain; border: 1px solid color-mix(in srgb, var(--tok-gold) 30%, transparent); border-radius: 2px;" />
    <img src="/images/tarot/rws/knight-of-wands.jpg" alt="Rider-Waite-Smith Knight of Wands" width="120" height="209" loading="lazy" decoding="async" style="display: block; width: 100%; height: auto; object-fit: contain; border: 1px solid color-mix(in srgb, var(--tok-gold) 30%, transparent); border-radius: 2px;" />
  </div>
  <figcaption style="margin: 0.75rem 0 0; font-family: var(--font-accent); font-style: italic; font-size: 0.92rem; line-height: 1.5; color: var(--tok-text-dark); opacity: 0.72;">The four Rider-Waite-Smith Knights: practical movement, emotional movement, intellectual movement, and creative movement.</figcaption>
</figure>
...
I used this four-Knight practice extensively while building [The Deck Compass](/practice/). Behind it sits systems, reader pathways, interpretive frameworks, and the development work that helps readers hone their abilities in a live environment. That build has taken eighteen months so far, with more still to come.
...
The Knights did not replace project management. They gave project management a more intuitive working intelligence, alongside [The COMPASS Method™](/articles/compass-method/) in the Tides of Knowing practice field.
