...
/** NZ Foundation Cohorts (June–July 2026) — source: docs/copy/compass-training-page-copy.md */
export const compassTrainingNz: CompassTrainingPage = {
  id: "nz",
  meta: {
  ...
  trainingPractice: {
    ...
    paragraphs: [
      ...
      "Foundation students complete training and move directly into The Deck Compass with three months of platform access included.",
    ],
  },
  problemFit: {
    label: "Problem fit",
  ...
  howItWorks: {
    ...
    closingParagraphs: [
      "The June and July 2026 cohorts are the foundation cohorts. They run while the programme is based in New Zealand, with sessions timed to suit UK and Australasia. A small number of places are available for US East Coast readers with flexible schedules.",
      "From August 2026 the programme moves to Mexico City, with session windows expanded to include US East, Central, and West Coast times.",
    ],
  },
  cohortSchedule: {
    variant: "nz",
    ...
    introParagraphs: [
      "Two foundation cohorts are available before the programme relocates internationally in August 2026.",
    ],
    cohortCards: [
      { title: "June 2026 cohort", status: "now open for applications" },
      { title: "July 2026 cohort", status: "applications open mid-June" },
    ],
    sessionWindowsSubheading: "Session windows (NZ-based cohorts)",
    sessionWindowCards: [
      {
        title: "Evening sessions (primary)",
        lines: [
          "7pm–9pm New Zealand Standard Time",
          "This is 8am–10am in the UK and Ireland, and 9am–11am in Eastern Australia.",
          "This is the primary window for UK, Irish, and Australian participants.",
        ],
      },
      {
        title: "Morning sessions",
        lines: [
          "8am–10am New Zealand Standard Time",
          "This is 9am–11am in Eastern Australia.",
          "Suited to readers in New Zealand and Australia.",
        ],
      },
      {
        title: "US East Coast",
        lines: [
          "A limited number of places are available for US East Coast readers.",
          "Your session window would be approximately 3pm–5pm US Eastern Time on the day prior to the NZ session date. Please note this clearly when applying and confirm you have a flexible schedule.",
          "US Central and US West Coast are not served by the NZ-based cohorts.",
        ],
      },
    ],
    fromAugustHeading: "From August 2026",
    fromAugustLead:
      "When the programme moves to Mexico City, session windows expand to include:",
    fromAugustBullets: [
      "UK and Ireland: Mexico City morning sessions, UK and Ireland afternoon",
      "US East and Central: evening sessions (afternoon–early evening Mexico City time)",
      "US West Coast: afternoon sessions (Mexico City time)",
    ],
    usWaitParagraph:
      "If you are based in the US and would prefer to wait for the Mexico City cohorts, you are welcome to register your interest and be contacted when enrolment opens.",
    registerInterest: {
      text: "Register your interest for US cohorts from August 2026",
      href: "/compass/apply/",
    },
  },
  investment: {
    ...
    tiers: [
      {
        ...
        body: [
          ...
          "Foundation pricing is available for the first cohorts only and reflects the direct access you have to the founder during the period when your experience shapes how the programme is taught. It is not a discount. It is a different kind of place.",
        ],
      },
      {
        title: "Foundation + Mentor Access · USD $797",
        body: [
          "Everything in Foundation, plus three observer sessions during your free platform period.",
      ...
      {
        title: "Foundation + Ongoing Mentorship · USD $1,197",
        body: [
          "Everything in Foundation + Mentor Access, plus one observer session per month for six months after the programme ends.",
    ...
    afterParagraphs: [
      ...
      "After that, platform access continues at USD $39 per month. Foundation students lock in at USD $29 per month for life.",
    ],
  },
  about: {
    label: "Authority",
  ...
  faq: {
    ...
    items: [
      ...
      {
        q: "What is the foundation pricing?",
        a: "Foundation cohorts are the first groups through the programme. You are not getting a discount. You are joining during the period when your direct experience informs how the training is taught. Foundation pricing closes when the foundation cohort period closes.",
      },
      {
        q: "I am in the US. Can I join the NZ cohorts?",
        a: "A limited number of places are available for US East Coast readers whose session window would fall at approximately 3pm–5pm Eastern Time. US Central and West Coast readers are better served by the Mexico City cohorts beginning in August 2026. You are welcome to register your interest now.",
      },
      {
        q: "I want to wait for the Mexico City cohorts. Can I register interest?",
        a: "Yes. Use the application form and note that you would like to be contacted when the August 2026 cohorts open.",
      },
      {
        q: "When do cohorts run?",
        a: "Monthly to start, with the first two cohorts in June and July 2026. Weekly cohorts will be introduced once demand is established. Apply now to be considered for the next available cohort.",
      },
      {
  ...
  apply: {
    ...
    checklist: [
      ...
      "Your location and preferred session window",
    ],
