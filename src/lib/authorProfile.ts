export const AUTHOR_NAME = "Leigh Spencer";

export const ABOUT_PATH = "/about/";

/** Compact line shown on articles and Field Notes (preserves existing trust intent). */
export const articleAuthorAttribution =
  "Fourth-generation Matakite (seer), tarot practitioner of 40+ years, professional journalist of 30 years, and founder of The COMPASS Method™.";
